      ...
      <div className="container px-8 relative z-10 mx-auto w-full">
        <div className="min-h-[400px] max-w-[800px] items-center flex flex-wrap -mx-8">
          <div className="relative flex-[1_0_0%] w-full px-8">
            <h1 className="max-w-[700px] leading-tight tracking-normal font-medium text-5xl lg:text-6xl">
              BlockTech is modernizing the housing finance process to help the
              dream of home ownership become a reality
            </h1>
            <p className="pb-8 leading-normal mb-4 text-xl ">
              BlockTech is digitizing and automating the entire real estate and
