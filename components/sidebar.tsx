    ...
    >
      <div className="p-5 shadow-sm bg-[#BEE3DB]">
        ...
        <div className="flex justify-between text-center">
          <Link
            href="#"
            className="w-[48%] bg-[#0DC9C9] py-2.5 px-3 rounded text-white before:content-['\e024']"
          >
            <i className="anticon anticon-file-add"></i>Deposit
          </Link>
          <Link
            href={ROUTES.STAKING}
            className='w-[48%] bg-[#0DC9C9] py-2.5 px-3 rounded text-white before:content-["\e01c"]'
          >
            <i className="anticon anticon-export"></i>Stake Now
          </Link>
        </div>
      </div>
        ...
        <ul className="relative list-none h-[calc(100vh-70px)] p-8 overflow-auto">
          <li className="relative block rounded-md mb-3">
            <Link
              ...
              className={`relative block py-2.5 px-5 rounded-[50px] font-bold text-sm uppercase z-10 ${
                pathname === ROUTES.DASHBOARD ? "bg-[#0DC9C9] text-white" : ""
              }`}
            >
          ...
          <li className="relative block rounded-md mb-3">
            <Link
              href={ROUTES.STAKING}
              className={`relative block py-2.5 px-5 rounded-[50px] font-bold text-sm uppercase z-10 ${
                pathname === ROUTES.STAKING ? "bg-[#0DC9C9] text-white" : ""
              }`}
            >
              <i className="anticon anticon-check-square"></i>
              <span>Staking Plan</span>
            </Link>
          </li>
          <li className="relative block rounded-md mb-3">
