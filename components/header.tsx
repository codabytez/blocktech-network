...
const DashboardHeader: NextPage<{ toggleSidebar: () => void, isSidebarOpen:boolean }> = ({
  toggleSidebar, isSidebarOpen
}) => {
  return (
    <div className="bg-[#FFF] h-[70px] fixed top-0 w-full z-100 flex">
      <div className={`border-r border-b border-[#dddddd85] w-[400px] transition-all duration-300 ${isSidebarOpen ? 'block' : 'hidden'}`}>
