          ...
          <div className="px-3 lg:px-24">
            <div className="">
              <div className="text-center">
                <h2 className="m-0 font-headings border-0 pb-0 font-medium normal-case leading-none text-xl md:text-4xl">
                  Why financial participants matter to the commodity markets
                </h2>
                <div className="mb-6"></div>
                <p className="text-xs md:text-lg">
                  Futures markets, and the global derivatives markets more
                  generally, have a long history around the world with origins
                  in the U.S. agricultural markets in the mid-19th century.
                </p>
                <div className="mb-6"></div>
                <div>
                  <Link
