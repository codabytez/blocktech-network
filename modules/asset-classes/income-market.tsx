...
import commodities from "@/public/images/Hero-Data_Tech-1920x550-15.jpg";

const IncomeMarket: NextPage = () => {
  return (
          ...
          <div className="pb-48 pl-5">
            <div className="">
              <h3 className="m-0 font-headings border-0 pb-0 font-medium normal-case leading-none print:break-after-avoid text-xl md:text-3xl">
                BlockTech is committed to increasing transparency, execution
                efficiency in fixed income markets
              </h3>
            ...
            <div className="flex gap-x-4 text-left flex-col md:flex-row">
              <div className="flex-1">
                <div className="flex py-2 border-t first:border-t-0 md:first:border-t-0 border-black">
                  ...
                  >
                    <div className="flex flex-1 flex-row items-center justify-between text-[0.95rem] md:text-base">
                      <div className="">Fixed Income</div>
                    ...
                    <div className="text-[0.75rem] font-light md:text-xs">
                      ...
                      decisions with end-to-end fixed income solutions
                    </div>
                  </Link>
                </div>
                <div className="flex py-2 border-t first:border-t-0 md:first:border-t-0 border-black">
                  ...
                  >
                    <div className="flex flex-1 flex-row items-center justify-between text-[0.95rem] md:text-base">
                      <div className="">Credit Derivatives</div>
                      <div className="flex flex-1 justify-start pl-4">
                        <svg
                          stroke="currentColor"
                          fill="currentColor"
                    ...
                    <div className="text-[0.75rem] font-light md:text-xs">
                      BlockTech is a leader in trade processing and risk
                      management for the global credit default swaps (CDS)
                      market
                    </div>
                  </Link>
                </div>
                <div className="flex py-2 border-t first:border-t-0 md:first:border-t-0 border-black">
                  ...
                  >
                    <div className="flex flex-1 flex-row items-center justify-between text-[0.95rem] md:text-base">
                      <div className="">Interest Rates</div>
                      <div className="flex flex-1 justify-start pl-4">
                        <svg
                          stroke="currentColor"
                          fill="currentColor"
                    ...
                    <div className="text-[0.75rem] font-light md:text-xs">
                      The largest marketplace for UK and European interest rates
                      futures and options including Euribor, SONIA, Gilts and
                      SARON futures
                    </div>
                  </Link>
                </div>
